...
Begin VB.Form patientsearch 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "patientsearch.frx":0000
      Height          =   6735
      Left            =   0
      TabIndex        =   2
      Top             =   2280
   ...
   End
End
Attribute VB_Name = "patientsearch"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub Command1_Click()
Adodc1.RecordSource = "select * from SALES where IDNUMBER='" + Text1.Text + "'"
Adodc1.Refresh
If Adodc1.Recordset.EOF Then
MsgBox "Record not found, please use another date.", vbInformation
Else
